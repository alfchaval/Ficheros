...
public class EscribirExterna extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_escritura_externa);
            ...
            public void onClick(View view) {
                ...
                if(miMemoria.disponibleEscritura()) {
                    if(miMemoria.escribirExterna(NOMBRE_FICHERO, texto, false, "UTF-8")) {
                        propiedades.setText(miMemoria.mostrarPropiedadesExterna(NOMBRE_FICHERO));
                    }
                    else {
